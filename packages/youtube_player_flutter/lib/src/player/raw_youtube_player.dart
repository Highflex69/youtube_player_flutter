...
class _RawYoutubePlayerState extends State<RawYoutubePlayer>
    ...
    return IgnorePointer(
      ...
      child: InAppWebView(
        ...
        onWebViewCreated: (webController) {
          ...
          _setupJsHandlers(webController);
        },
        onLoadStop: (_, __) {
  ...
  void _setupJsHandlers(InAppWebViewController webController) {
    webController
      ...
      ..addJavaScriptHandler(
        ...
        callback: (args) {
          ...
          switch (args.first as int) {
            ...
            default:
              final e =
                  Exception("Invalid player state obtained: ${args.first}");
      ...
      ..addJavaScriptHandler(
        ...
        callback: (args) {
          ...
          final num? buffered = args.lastOrNull;
          controller?.updateValue(
